...
_LABELS: dict[str, str] = {
    ...
    # Candle model exits (1m close rules) — doc §2 outcome names
    "stopped_before_trigger": "Stop — 1m candle closed at/below E×0.90 before ramp armed",
    "ramping_trail_exit": "Ramping trail — price fell below ratcheted floor",
    "emergency_stop_18pct": "Emergency stop — 1s tick at/below −18% loss",
    "intrabar_stop_exit": "Emergency stop — tick breached E×0.90 before bar close",
    "intrabar_ramp_exit": "Ramp exit — 1s tick breached ratchet floor",
    "stale_quote_halt_exit": "Stale quote halt — flattened after frozen broker price",
    "ticker_loss_cooldown": "Skipped — ticker loss cooldown after recent losing exit",
    "ticker_reentry_cooldown": "Skipped — re-entry cooldown after recent exit on same ticker",
    "ticker_daily_trade_cap": "Skipped — max trades per ticker today reached",
    "entry_chase_exceeded": "Skipped — live price too far above alert (chase cap)",
    "squeeze_reentry_blocked": "Skipped — squeeze re-entry blocked after prior stop",
    "momentum_scratch_90s_squeeze": "90s scratch — dead squeeze (peak below +1%)",
    "ramping_end_day": "End of day — flat while ramping trail armed",
    "protected_profit_exit": "Protected exit — closed below E×1.075 floor (legacy)",
    "runner_trail_exit": "Runner trail — closed 15% below peak runner close (legacy)",
    "unprotected_end_day": "End of day — flat before +7.5% ramp arm",
    "protected_end_day": "End of day — flat while protected (legacy)",
    "runner_end_day": "End of day — flat while in runner mode (legacy)",
    # Legacy staged_* aliases (pre-doc rename)
    ...
    # Entry rules (doc §1)
    "alert2_extreme_tape_confirmed": "Entry — alert #2 extreme tape",
    "clean_catalyst_trade": "Entry — clean catalyst trade",
    "squeeze_momentum_trade": "Entry — squeeze momentum trade",
    "pure_tape_trade": "Entry — pure tape trade",
    "extreme_tape_trade": "Entry — extreme tape trade",
    "alert_number_1": "Skipped — alert #1 (need prior alert)",
    "no_prior_same_day_alert": "Skipped — no prior same-day alert",
    "price_not_above_prior": "Skipped — price not above prior alert",
    "rv_missing": "Skipped — RV missing",
    "reverse_split_present": "Skipped — reverse split present",
    "label_rev_v": "Skipped — REV V label",
    "label_btt_v": "Skipped — BTT V label",
    "momentum_change_over_80": "Skipped — MOMENTUM with change > 80%",
    "entry_rules_watch": "Watching — no approved setup yet",
    "entry_rules_skip": "Skipped — entry rules",
    "TRADE_NOW": "Approved — market buy after alert",
    "WATCH_ONLY": "Watching — tape not ready for entry",
    "known_runner_no_news": "Skipped — Known Runner without news or squeeze",
    "momentum_scratch_90s": "90s scratch — no momentum (early alert, peak <3%)",
    "ai_downgrade": "Downgraded by AI entry review",
